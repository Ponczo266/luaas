...
-- Tłumaczenie wiadomości głównej
local text = "Wykryto nieznany patowogen rozprzestrzeniający się w twoim sektorze. Twoja lokalizacja zostaje objęta ścisłą kwarantanną do odwołania. W międzyczasie postaramy się opracować procedurę twojej ewakuacji."
...
function PANEL:Paint(w, h)
	...
	-- Spolszczony nagłówek "Obiekt #0"
	draw.GlowingText("Obiekt #0", "ZB_PathowogenDialogueTitle", w * 0.31, 0 - ScreenScale(1), ColorAlpha(red, 255), ColorAlpha(red, 235), ColorAlpha(red, 10), TEXT_ALIGN_LEFT)
