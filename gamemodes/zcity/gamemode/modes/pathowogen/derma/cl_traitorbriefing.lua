...
function PANEL:Init()
    ...
    -- Spolszczona instrukcja dla kontraktora
    self.dialogue:SetText("Twój cel jest prosty: wyeliminuj wszystkich ocalałych. Wyposażenie musisz zdobyć na miejscu. Ewakuujemy cię dopiero po wykonaniu zadania.", 2)
    
    timer.Simple(15, function()
        if !IsValid(self) then return end
        
        -- Krótkie pożegnanie
        self.dialogue:SetText("Powodzenia. Bez odbioru.")
