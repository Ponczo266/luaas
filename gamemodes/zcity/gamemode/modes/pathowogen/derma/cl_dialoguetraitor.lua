...
-- Tłumaczenie głównej wiadomości
local text = "W twojej okolicy szaleje nieznany wirus - patowogen. Twój obszar zostaje objęty natychmiastową kwarantanną do odwołania. W międzyczasie postaramy się ustalić plan twojej ewakuacji."
...
function PANEL:Paint(w, h)
	...
	-- Zmieniony nagłówek na "Kontraktor"
	draw.GlowingText("Kontraktor", "ZB_PathowogenDialogueTitle", w * 0.31, 0 - ScreenScale(1), ColorAlpha(red, 255), ColorAlpha(red, 235), ColorAlpha(red, 10), TEXT_ALIGN_LEFT)
