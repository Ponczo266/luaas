...
-- Spolszczona wiadomość startowa
local text = "W twoim obecnym sektorze wykryto nieznany wirus – patowogen. Twój obszar zostaje objęty natychmiastową kwarantanną do odwołania. W międzyczasie spróbujemy opracować plan twojej ewakuacji."
...
function PANEL:Paint(w, h)
	...
	-- Spolszczony tytuł: Dowódca
	draw.GlowingText("Dowódca", "ZB_PathowogenDialogueTitle", w * 0.31, 0 - ScreenScale(1), ColorAlpha(red, 255), ColorAlpha(red, 235), ColorAlpha(red, 10), TEXT_ALIGN_LEFT)
