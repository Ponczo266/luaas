...
local Selects = {
    {Title = "Rozłącz", Func = function(luaMenu) RunConsoleCommand("disconnect") end},
    {Title = "Menu główne", Func = function(luaMenu) gui.ActivateGameUI() luaMenu:Close() end},
    {Title = "Ustawienia", Func = function(luaMenu) luaMenu:Close() RunConsoleCommand("hg_settings") end},
    {Title = "Discord", Func = function(luaMenu) luaMenu:Close() gui.OpenURL("https://discord.gg/FYvut7QC7v")  end},
    ...
    {Title = "Osiągnięcia", Func = function(luaMenu) luaMenu:Close() RunConsoleCommand("hg_achievements") end},
    {Title = "Wygląd", Func = function(luaMenu) luaMenu:Close() RunConsoleCommand("hg_appearance_menu") end},
    {Title = "Sklep", Func = function(luaMenu) luaMenu:Close() RunConsoleCommand("hg_pointshop") end},
	{Title = "Nagrody Dzienne", Func = function(luaMenu) luaMenu:Close() RunConsoleCommand("hg_daily_rewards") end},
    {Title = "Rola Zdrajcy",
    GamemodeOnly = true,
    ...
    {Title = "Wróć", Func = function(luaMenu) luaMenu:Close() end},
}
...
function PANEL:Init()
    ...
    zteam:SetText("Authors: uzelezz, Sadsalat, Mr.Point, Zac90, Deka, Mannytko + MEDYK [j. Polski]")
