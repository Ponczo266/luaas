...
hg.Accessories = {
    ...
    ["02"] = {
        ...
        malepos = {Vector(3.2,-2.8,0),Angle(0,-75,-90),0.9},
        fempos = {Vector(2.2,-2.6,0),Angle(0,-75,-90),0.85},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["03"] = {
        ...
        price = 1200,
        vpos = Vector(0,0,69),
        name = "Glasses Style 3"
    },

    ["snowboard"] = {
        model = "models/gmod_tower/snowboardgoggles.mdl",
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(3.6,-1.5,0),Angle(0,-80,-90),0.9},
        fempos = {Vector(2.6,-1.5,0),Angle(0,-85,-90),0.85},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["3d"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(2.8,-2.8,0),Angle(0,-80,-90),1},
        fempos = {Vector(2.5,-3.1,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["star"] = {
        ...
        fempos = {Vector(2.5,-2.5,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["aviators_gmod"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(3,-2,0),Angle(0,-80,-90),1},
        fempos = {Vector(2,-2,0),Angle(0,-80,-90),0.95},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["duck_tube"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(4,0,0),Angle(0,-80,-90),0.8},
        fempos = {Vector(3,0,0),Angle(0,-85,-90),0.75},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["pumpkin"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(5,0,0),Angle(0,-80,-90),0.85},
        fempos = {Vector(4,0,0),Angle(0,-85,-90),0.8},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["luigi"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(-0.5,0,0),Angle(0,-75,-90),1},
    ...
    ["mario"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(2,0,0),Angle(0,-75,-90),1},
        fempos = {Vector(1,0,0),Angle(0,-75,-90),0.95},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["reds"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(3,0.5,0),Angle(0,-80,-90),1},
        fempos = {Vector(2,0.5,0),Angle(0,-80,-90),0.95},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["servbot"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(1,-0.5,0),Angle(0,-80,-90),0.85},
        fempos = {Vector(0,-0.5,0),Angle(0,-85,-90),0.8},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["toad"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(-1,0,0),Angle(0,-75,-90),0.9},
        fempos = {Vector(-2,0,0),Angle(0,-75,-90),0.85},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["majoras"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(2.5,-1.5,0),Angle(0,-80,-90),1},
        fempos = {Vector(1.5,-1.5,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
        price = 4500,
        vpos = Vector(0,0,69),
        name = "Majora's Mask Hat"
    },

    ["rubiks"] = {
        model = "models/gmod_tower/rubikscube.mdl",
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(6,0,0),Angle(0,-80,-90),0.7},
        fempos = {Vector(5,0,0),Angle(0,-85,-90),0.65},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
        price = 2500,
        vpos = Vector(0,0,69),
        name = "Rubik's Cube Hat"
    },

    ["santa"] = {
        model = "models/gmod_tower/santahat.mdl",
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(5,0,0),Angle(0,-75,-90),1.1},
        fempos = {Vector(4,-0.1,0),Angle(0,-75,-90),1.05},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["seuss"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(5,-0.5,0),Angle(0,-75,-90),0.85},
        fempos = {Vector(4,-0.5,0),Angle(0,-75,-90),0.8},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["toro"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(2,-1,0),Angle(0,-80,-90),1},
        fempos = {Vector(1,-1,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["bunny_ears"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(5,0,0),Angle(0,-80,-90),1},
        fempos = {Vector(4,0,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    -- FIX: Cat Ears - jeszcze niżej (X z 1 na -1)
    ["cat_ears"] = {
        model = "models/captainbigbutt/skeyler/hats/cat_ears.mdl",
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(-1,0,0),Angle(0,-80,-90),1},
        fempos = {Vector(-2,0,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["santa_skeyler"] = {
        ...
        price = 1500,
        vpos = Vector(0,0,69),
        name = "Santa Hat (Skeyler)"
    },

    ["general_pepper"] = {
        model = "models/lordvipes/generalpepperhat/generalpepperhat.mdl",
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(4,0.5,0),Angle(0,-75,-90),0.9},
        fempos = {Vector(3,0.5,0),Angle(0,-75,-90),0.85},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    -- FIX: Lego Head - do przodu trochę (Y z -0.5 na -2)
    ["legohead"] = {
        model = "models/gmod_tower/legohead.mdl",
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(3.5,-2,0),Angle(0,-80,-90),0.85},
        fempos = {Vector(2.5,-2,0),Angle(0,-85,-90),0.8},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["keaton"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(2.5,0.5,0),Angle(0,-80,-90),1},
        fempos = {Vector(1.5,0.5,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["jason_halloween"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(-3,-1.5,0),Angle(0,-80,-90),1},
        fempos = {Vector(-4,-1.5,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["daftpunk_thomas"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(3,-1.5,0),Angle(0,-80,-90),1},
        fempos = {Vector(2,-1.5,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["kfc_bucket"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(5,-1.5,0),Angle(0,-80,-90),0.85},
        fempos = {Vector(4,-1.5,0),Angle(0,-85,-90),0.8},
        skin = 0,
        norender = true,
        placement = "head",
        bPointShop = true,
    ...
    ["noface"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(3,-7,0),Angle(0,-80,-90),1},
        fempos = {Vector(2,-7,0),Angle(0,-80,-90),0.95},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    -- FIX: Meta Knight - jeszcze bardziej do przodu (Y z -4 na -6)
    ["metaknight"] = {
        model = "models/gmod_tower/metaknight_mask.mdl",
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(1,-6,0),Angle(0,-80,-90),0.9},
        fempos = {Vector(0,-6,0),Angle(0,-85,-90),0.85},
        skin = 0,
        norender = true,
        placement = "face",
        bPointShop = true,
    ...
    ["nerd tooths"] = {
        ...
        bone = "ValveBiped.Bip01_Head1",
        malepos = {Vector(2,-2.5,0),Angle(0,-85,-90),1},
        fempos = {Vector(0.8,-2.5,0),Angle(0,-85,-90),0.95},
        skin = 0,
        norender = true,
        placement = "spine",
        bonemerge = true,
...
hook.Add("ZPointshopLoaded","LoadAccessories",function()
    ...
    if not PLUGIN then
        print("[Z-CITY ERROR] Krytyczny błąd: Nie znaleziono tabeli PointShop!")
        return
    end

    if not PLUGIN.CreateItem then
        print("[Z-CITY ERROR] Tabela PointShop istnieje, ale brakuje funkcji CreateItem!")
        return
    end
    ...
    print("[Z-CITY] Akcesoria załadowane pomyślnie!")
end)