...
local BootStages = {
	[1] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[2] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[3] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("GLOBALNY TEST SYSTEMU:", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 2 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[4] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("GLOBALNY TEST SYSTEMU:", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 2 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OPTYKA: OK", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 3 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("DOTYK: OK", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 4 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("SŁUCH: OK", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 5 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("WĘCH: MODUŁ NIEODNALEZIONY", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("SMAK: MODUŁ NIEODNALEZIONY", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[5] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("WĘCH: MODUŁ NIEODNALEZIONY", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("SMAK: MODUŁ NIEODNALEZIONY", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Skanowanie pamięci: W TOKU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[6] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("WĘCH: MODUŁ NIEODNALEZIONY", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("SMAK: MODUŁ NIEODNALEZIONY", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Skanowanie pamięci: UKOŃCZONE", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[7] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("SMAK: MODUŁ NIEODNALEZIONY", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Skanowanie pamięci: UKOŃCZONE", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Dostrajanie pamięci: W TOKU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[8] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("SMAK: MODUŁ NIEODNALEZIONY", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Skanowanie pamięci: UKOŃCZONE", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Dostrajanie pamięci: UKOŃCZONE", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[9] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Skanowanie pamięci: UKOŃCZONE", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Dostrajanie pamięci: UKOŃCZONE", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Inicjalizacja świadomości...", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 10 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[10] = function(init2)
		draw.SimpleText("INICJALIZACJA ROZRUCHU SYSTEMU", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Wersja OwOS: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Dostrajanie pamięci: UKOŃCZONE", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Inicjalizacja świadomości...", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 10 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("echo \"Miłego :3 dnia!\"", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 11 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
}
...
function PANEL:Paint()
	...
	-- Tłumaczenie napisu ładowania
	local text = "Ładowanie..."
	local trim = 9 + (math.Round(CurTime()) % 3)
    ...
    -- Reszta paska postępu bez zmian...
...
hook.Add("RenderScreenspaceEffects", "furload", function()
	if IsValid(hg.furload) and hg.furload.alpha != 255 then
		...
		-- Tłumaczenie pożegnalnego tekstu
		draw.SimpleText("Miłego :3 dnia!", "ZB_ProotOSMedium", sw * 0.5 + 2, sh * 0.8 + 2, ColorAlpha(color_black, 255 * alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText("Miłego :3 dnia!", "ZB_ProotOSMedium", sw * 0.5, sh * 0.8, ColorAlpha(bluewhite, 255 * alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end)
